...
> - **Actions**: `useActionState` cho form handling thay vì useState + event handlers
> - **Data Fetching**: `use()` hook với Suspense thay vì useEffect patterns
> - **Optimistic Updates**: `useOptimistic` cho social features (likes, comments)
