...
import { User, FitnessGoal, ExperienceLevel } from '../../types';
...
function FitnessStatsSection({ user, userProfile }: FitnessStatsSectionProps) {
    ...
    const experienceLevelProgress = useMemo(() => {
        switch (user.profile.experienceLevel) {
        ...
        <Card sx={{ mb: 3 }}>
            <CardContent>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                        <Box sx={{ mb: 3 }}>
                            ...
                            <Typography variant="h5" gutterBottom>
                                {user.profile.height} <Typography component="span" variant="body2">cm</Typography>
                            </Typography>
                        </Box>
                        ...
                        <Box>
                            ...
                            <Typography variant="h5">
                                {user.profile.weight} <Typography component="span" variant="body2">kg</Typography>
                            </Typography>
                        </Box>
                    </Grid>
                    ...
                    <Grid item xs={12}>
                        ...
                        <Box display="flex" alignItems="center">
                            ...
                            <Typography variant="body1">
                                {getExperienceLevelLabel(user.profile.experienceLevel)}
                            </Typography>
                        </Box>
                    </Grid>
                    ...
                    {user.profile.medicalConditions && user.profile.medicalConditions.length > 0 && (
                        <Grid item xs={12}>
                            <Divider sx={{ my: 2 }} />
                            <Typography variant="subtitle1" gutterBottom>
                            ...
                            <Box display="flex" flexWrap="wrap" gap={1}>
                                {user.profile.medicalConditions.map((condition, index) => (
                                    <Chip
                                        key={index}
                                        label={condition}
                                        color="error"
